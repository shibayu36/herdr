...
impl KeysConfig {
    ...
    pub(crate) fn local_profile(&self, keybinds: &Keybinds) -> KeysConfigOverlay {
        ...
        copy_effective_action_field!(copy_mode_previous_word, keybinds.copy_mode_keys.previous_word);
        copy_effective_action_field!(copy_mode_next_word_end, keybinds.copy_mode_keys.next_word_end);
        copy_effective_action_field!(copy_mode_next_big_word, keybinds.copy_mode_keys.next_big_word);
        ...
        copy_effective_action_field!(copy_mode_start_of_line, keybinds.copy_mode_keys.start_of_line);
